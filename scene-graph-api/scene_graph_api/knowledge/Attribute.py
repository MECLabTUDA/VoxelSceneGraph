...
class Attribute(KnowledgeComponent, ABC):
    """
    ...
    def schema(cls) -> dict:
        return {
            "id": "Attribute",  # Ugly... but avoids creating schemas for subclasses
            "type": "object",
            "properties": {
    ...
    def long_to_value_instance(self, value: int) -> Any:
        """Revert (if possible) value_instance_to_long."""
        return 0
...
class IntAttribute(Attribute):
    ...
    def long_to_value_instance(self, value: int) -> int:
        """Convert a value to an int for long storage (if possible)."""
        return int(value)
...
class BoolAttribute(Attribute):
    ...
    def long_to_value_instance(self, value: int) -> bool:
        """Convert a value to an int for long storage (if possible)."""
        return bool(value)
