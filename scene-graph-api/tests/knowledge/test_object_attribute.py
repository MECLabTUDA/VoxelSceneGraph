...
class TestAttribute(TestCase):
    logger = logging.getLogger("knowledge/Attribute")
    handler = TestingHandler()
    validator = get_validator(Attribute.schema(), registry=KnowledgeComponent.SCHEMA_REGISTRY)
    ...
    def test_from_json_valid(self):
        json_dict = {Attribute._id_key: 2, Attribute._name_key: "name", Attribute._type_key: "str"}
    ...
    def test_from_json_no_type(self):
        json_dict = {Attribute._id_key: 2, Attribute._name_key: "name"}
    ...
    def test_from_json_with_str_type(self):
        json_dict = {
            Attribute._id_key: 2,
            Attribute._name_key: "name",
            Attribute._type_key: StrAttribute.get_attribute_type()
        }
    ...
    def test_from_json_with_int_type(self):
        json_dict = {
            Attribute._id_key: 2,
            Attribute._name_key: "name",
            Attribute._type_key: IntAttribute.get_attribute_type()
        }
    ...
    def test_from_json_with_float_type(self):
        json_dict = {
            Attribute._id_key: 2,
            Attribute._name_key: "name",
            Attribute._type_key: FloatAttribute.get_attribute_type()
        }
    ...
    def test_from_json_with_bool_type(self):
        json_dict = {
            Attribute._id_key: 2,
            Attribute._name_key: "name",
            Attribute._type_key: BoolAttribute.get_attribute_type()
        }
    ...
    def test_from_json_with_enum_type_no_values(self):
        json_dict = {
            Attribute._id_key: 2,
            Attribute._name_key: "name",
            Attribute._type_key: EnumAttribute.get_attribute_type()
        }
    ...
    def test_from_json_unknown_type(self):
        json_dict = {
            Attribute._id_key: 2,
            Attribute._name_key: "name",
            Attribute._type_key: "def not a type"
        }
        self.assertEqual(1, len(list(self.validator.iter_errors(json_dict))))
