"""
Training script for training a roi heads (box, mask...) separately from the one-stage object detector.
It can also be useful to pretrain feature extractors for relation prediction.
...
def main():
    ...
    model = run_train(
        ...
        device,
        evaluation_type,
        LossComputationCfg(False, True, False),
        args.distributed,
        logger
    )
