...
class TestCoco2d(unittest.TestCase):
    ANN_PATH_OBJ = "./test_annotations/dummy_2d_obj_detec.json"
    ANN_PATH_SEG = "./test_annotations/dummy_2d_seg.json"

    def test___init___object_detection(self):
        coco = COCO(self.ANN_PATH_OBJ)
