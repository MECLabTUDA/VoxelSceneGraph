...
class AdaptiveFedOptServerOptimizer(ServerOptimizer):
    def __init__(self, beta: float = 0.9, lr: float = 0.1, tau: float = 1e-9):
...
class FedYogiServerOptimizer(AdaptiveFedOptServerOptimizer):
    ...
    def update_velocity(
        ...
        return old_velocity - (1 - self.beta_2) * delta2 * torch.sign(old_velocity - delta2)
