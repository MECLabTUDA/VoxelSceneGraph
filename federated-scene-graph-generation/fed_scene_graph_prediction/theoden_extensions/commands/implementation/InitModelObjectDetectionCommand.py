...
class InitModelObjectDetectionCommand(Command, Transferable):
    def execute(self):
        ...
        model, optimizer, scheduler, device = build_training_basics(0, False, logger)
        ...
        self.client_rm["compute_loss"] = LossComputationCfg(True, True, False)
